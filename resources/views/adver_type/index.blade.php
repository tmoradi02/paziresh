...
@section('content')
    ...
    @can('Insert_Adver_Type')  <!-- Check For Access Permission User -->
    ...
    <form action="{{route('adver_type_search')}}" method="get"> 
        ...
        <div class="card" style="margin-right:10px; margin-left:10px; width:500px; max-width:98%; "> 
            ...
            <div class="card-body"> 
                <div class="row mx-auto" > 
                    ...
                    <div class="col-md" > 
                        ...
                        <label class="col-5" for="adver-Type" style="margin-right:-35px;">نوع کدآگهی</label> 
                            <input type="text" id="adver-Type" name="adver_type" placeholder="نوع کدآگهی" class="form-control" style="margin-right:-30px; width:300px;"> 
                        </div> 
                    </div> 
        ...
        @foreach($adver_types as $adver_type)
            <tr class="rowt" style="height:1px;">
                ...
                <td class="btn-group" style="height:10%;">
                    @can('Edit_Adver_Type')  <!-- Check For Access Permission User -->
                    ...
                    @can('Delete_Adver_Type')  <!-- Check For Access Permission User -->
    ...
    <div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModalLabel" aria-hidden="true" style="max-width:100%;">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Edit Form -->
                    <form action="" class="edit-adver-type" method="post" style="max-width:100%;">
                        @csrf
                        @method('put')
