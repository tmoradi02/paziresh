...
return [
    ...
    */
    ...
    [
        ...
        'string' => 'فقط کاراکتر وارد نمایید' , 
    ],
    'email' => 
    [
        'required' =>  'ایمیل الزامی می باشد' ,
        'unique' => 'ایمیل تکراری می باشد' ,
        'min' => 'حداقل 14 کاراکتر وارد نمایید' ,
        'email' => 'ایمیل وارد نمایید' ,
    ],
    'password' => 
    [
        'min' =>  'حداقل 8 کاراکتر وارد نمایید' ,
        'required' =>  'کلمه عبور الزامی می باشد' ,
        'min' =>  'حداقل 8 کاراکتر یا عدد وارد نمایید' ,
    ],
    'tell' => 
    [
        'required' => 'شماره تلفن الزامی می باشد' ,
        'min' => 'حداقل 11 رقم وارد نمایید' ,
        'unique' => 'شماره تلفن تکراری می باشد' ,
        'numeric' => 'فقط عدد وارد نمایید' ,
    ] ,
    ...
    [
        ...
        'min' =>  'حداقل 1 رقم وارد نمایید',
        'max' =>  'حداکثر 3 رقم وارد نمایید',
    ],
    ...
    [
        ...
        'min' =>  'حداقل 1 کاراکتر وارد نمایید',
    ],
    ...
    [
        ...
        'min' =>  'حداقل 1 رقم وارد نمایید',
        'max' => 'حداکثر 3 رقم وارد شود' ,
        'numeric' => 'فقط عدد وارد شود', 
        'gt' => 'عدد وارد شده از صفر بزرگتر باشد',
        'between' =>  'عدد وارد شده باید بین 1 تا 200 باشد',
    ],
    'from_date' => 
    [
    ...
    [
        'required' =>  'عنوان باکس الزامی می باشد',
        'min' => 'حداقل 3 کاراکتر وارد نمایید',
        'max' => 'حداکثر 30 کاراکتر وارد نمایید',
    ],
    ...
    [
        ...
        'min' => 'حداقل 3 کاراکتر وارد نماید' , 
    ],
    ...
    [
        ...
        'unique' => 'نام صاحب اگهی تکراری می باشد' ,
        'min' => 'حداقل 3 کارکتر وارد نمایید', 
    ],
    ...
    'product' => 
    [
        'required' => 'عنوان محصول تکراری می باشد' ,
        'min' => 'حداقل 3 کاراکتر وارد نمایید' ,
    ],
